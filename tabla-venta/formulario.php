...
<body>
    ...
    <form action="operacion_guardar.php" method="POST" class="formulario">
        ...
        <input type="date" required name="fecha" class="formulario__input">
        ...
        <input type="number" required name="cantidad_prodcuto" class="formulario__input">
        <laber class="formulario__label">Cantidad Producto</laber>
