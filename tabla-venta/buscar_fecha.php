...
<body>
    ...
    <form action="fecha.php" method="POST" class="formulario">
        <select class="formulario__input" required name="fecha" >
            <?php
                include("conexion.php");
                $query = "SELECT DISTINCT fecha FROM ventas; ";
        ...
        <laber class="formulario__label">Seleccione la Fecha: </laber>
