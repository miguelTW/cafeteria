...
<body>
    ...
    <form action="empleadoid.php" method="POST" class="formulario">
        <select class="formulario__input" required name="empleado_id" >
            <?php
                include("conexion.php");
                $query = "SELECT DISTINCT empleado_id FROM ventas; ";
        ...
        <laber class="formulario__label">Seleccione el Empleado ID: </laber>
