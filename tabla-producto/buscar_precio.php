...
<body>
    ...
    <form action="precio.php" method="POST" class="formulario">
        <select class="formulario__input" required name="precio" >
            <?php
                include("conexion.php");
                $query = "SELECT DISTINCT precio FROM producto; ";
        ...
        <laber class="formulario__label">Seleccione el Precio: </laber>
