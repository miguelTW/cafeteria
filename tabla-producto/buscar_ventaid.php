...
<body>
    ...
    <form action="ventaid.php" method="POST" class="formulario">
        <select class="formulario__input" required name="venta_id" >
            <?php
                include("conexion.php");
                $query = "SELECT DISTINCT venta_id FROM producto; ";
                ...
                if (mysqli_num_rows($query_result) > 0) {
                    while($row = mysqli_fetch_array($query_result)){
                        ...
                        echo "<option value = '".$row["venta_id"]."'>" . $row["venta_id"] . "" . "</option>";
                    }
                } else {
                    echo "0 results";
                }
        ...
        <laber class="formulario__label">Seleccione Venta ID: </laber>
